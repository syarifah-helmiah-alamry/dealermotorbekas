    ...
    <div class="d-flex" id="wrapper">
        <div class="bg-3" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a href="M_data_transaksi.php" class="list-group-item list-group-item-action bg-transparent warna-1 fw-bold">Transaksi</a>
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-2 py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0 warna-1">Home</h2>
                </div>
            </nav>
<!-- Page Content -->
            <div class="container-fluid px-5">
                <div class="row my-5">
                    <h3 class="fs-4 mb-3 warna-1">Customer <?php echo $_SESSION['nama'] ?></h3>
                </div>
            </div>  
        </div>
    </div>
