                                ...
                                while ($row = mysqli_fetch_array($queryTransaksi)){?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#editTrsk<?php echo $row['IdTrsk'] ?>" style="width: 75px;">Edit</button>
                                            <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#hapusTrsk<?php echo $row['IdTrsk'] ?>" style="width: 75px;">Hapus</button>
                                        </td>
...
<!-- Modal Edit Data Motor -->     
                                        <form method="POST" class="form-group">
                                            <div class="modal fade text-start" id="editTrsk<?php echo $row['IdTrsk'] ?>" tabindex="-1" aria-labelledby="alertModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="text-center mb-3">
                                                                <img src="../gambarMotor/<?php echo $row['gambar_motor'] ?>" style="height: 150px;">
                                                            </div>
                                                            <div class="row pb-3">
                                                                <div class="col-5 mt-1"><label>Tanggal Transaksi</label></div>
                                                                <div class="col">
                                                            ...
                                                            <div class="row pb-3">
                                                                <div class="col-5 mt-1"><label>ID Transaksi</label></div>
                                                                <div class="col">
                                                                    <input name="IdTrsk" type="text" class="form-control form-box" readonly value="<?php echo $row['IdTrsk'] ?>">
                                                                </div>
                                                            </div>
                                                            <div class="row pb-3">
                                                                <div class="col-5 mt-1"><label>ID Customer</label></div>
                                                                <div class="col">
                                                                    <input type="text" name="id_cust" class="form-control form-box" readonly value="<?php echo $row['id_cust'] ?>">
                                                                </div>
                                                            </div>
                                                            <div class="row pb-3">
                                                                <div class="col-5 mt-1"><label>Nama Customer</label></div>
                                                                <div class="col">
                                                                    <input type="text" name="nama_cust" class="form-control form-box" value="<?php echo $row['nama_cust'] ?>">  
                                                                </div>
                                                            </div>
                                                            <div class="row pb-3">
                                                                <div class="col-5 mt-1"><label>Alamat Customer</label></div>
                                                                <div class="col">
                                                                    <input type="text" name="alamat_cust" class="form-control form-box" value="<?php echo $row['alamat_cust'] ?>">
                                                                </div>
                                                            </div>
                                                            <div class="row pb-3">
                                                                <div class="col-5 mt-1"><label>Telp Customer</label></div>
                                                                <div class="col">
                                                                    <input type="text" name="telp_cust" class="form-control form-box" value="<?php echo $row['telp_cust'] ?>">
                                                                </div>
                                                            </div>
                                                            <div class="row pb-3">
                                                                <div class="col-5 mt-1"><label>NIK Customer</label></div>
                                                                <div class="col">
                                                                    <input type="text" name="nik_cust" class="form-control form-box" value="<?php echo $row['nik_cust'] ?>">
                                                                </div>
                                                            </div>
                                                            <div class="row pb-3">
                                                                <div class="col-5 mt-1"><label>ID Kendaraan</label></div>
                                                            ...
                                                            <div class="row pb-3">
                                                                <div class="col-5 mt-1"><label>Harga Jual</label></div>
                                                                <div class="col">
                                                                    <input type="text" name="Harga_Jual" class="form-control form-box" value="<?php echo $row['Harga_Jual'] ?>">
                                                                </div>
                                                            </div>
                                                            <div class="row pb-3">
                                                                <div class="col-5 mt-1"><label>Harga Jual Real</label></div>
                                                            ...
                                                            <div class="row">  
                                                                <div class="col-md-12 d-flex justify-content-end">
                                                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#alerteditTrsk<?php echo $row['id'] ?>">Simpan</button>
                                                                </div>                                     
                                                            </div>   
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="modal fade text-start" id="alerteditTrsk<?php echo $row['id'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="submit" class="btn btn-primary" name="editTrsk">Yes</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>  
...
<!-- Tombol Konfirmasi Hapus Motor-->
                                        <form method="POST" class="form-group">
                                            ...
                                            <div class="modal fade text-start" id="hapusTrsk<?php echo $row['IdTrsk'] ?>" tabindex="-1" aria-labelledby="alertHapusModal" aria-hidden="true">
